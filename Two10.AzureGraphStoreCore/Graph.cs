...
namespace Two10.AzureGraphStoreCore
{
    public class Graph
    {
                    ...
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.InsertOrReplace(entity1)).Wait();
                        },
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.InsertOrReplace(entity2)).Wait();
                        },
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.InsertOrReplace(entity3)).Wait();
                        }
                };
                    ...
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.Delete(entity1)).Wait();
                        },
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.Delete(entity2)).Wait();
                        },
                    () =>
                        {
                            ...
                            table.ExecuteAsync(TableOperation.Delete(entity3)).Wait();
                        }
                };
        ...
        {
            var val = table.ExecuteAsync(TableOperation.Retrieve<GraphEntity>(JoinKey(SUBJECT_VALUE, subject, value), KeyEncoder(property))).Result;
            if (null != val.Result)
            {
        ...
        private IEnumerable<Triple> QueryTriples(string dimension, string pk1, string pk2)
        {
            ...
            return table.ExecuteQuerySegmentedAsync(query,null).Result.Select(entity => entity.ToTriple());
        }
